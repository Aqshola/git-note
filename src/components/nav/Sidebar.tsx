...
export default function Sidebar() {
    ...
    return <motion.div
        ...
        <div >
            <button className='flex p-2 bg-purple-primary text-white rounded text-sm gap-2 w-full justify-center font-comic-neue items-center'>
            ...
            <button onClick={handleAddFolder} className='flex p-2 border border-purple-primary text-purple-primary rounded text-sm gap-2 w-full justify-center font-comic-neue items-center mt-3 border-sketch'>
